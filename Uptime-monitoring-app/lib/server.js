...
server.init = function(){
    ...
    server.httpServer.listen(config.httpPort, function(){
        console.log('\x1b[35m%s\x1b[0m',"The Server is listening on port "+config.httpPort+" in "+config.envName+" model.");
    });

    // Start the https server
    server.httpsServer.listen(config.httpsPort, function(){
        console.log('\x1b[36m%s\x1b[0m',"The Server is listening on port "+config.httpsPort+" in "+config.envName+" model.");
    });
}
